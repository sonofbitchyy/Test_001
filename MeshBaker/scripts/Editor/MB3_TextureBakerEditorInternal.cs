...
namespace DigitalOpus.MB.Core{
	public class MB3_TextureBakerEditorInternal{
        ...
        private SerializedProperty objectsParent;
        ...
        private MB3_TextureBaker _target;
        ...
        private static GUIContent objectParentGUIContent = new GUIContent("ObjectParent", "Select parentObject of the objects to be conbimed");
		...
		void _init(MB3_TextureBaker target) {
            ...
            objectsParent = textureBaker.FindProperty("objectParent");
		}	
		...
		public void DrawGUI(MB3_TextureBaker mom, System.Type editorWindow){
	        ...
	        EditorGUILayout.PropertyField(objectsParent,objectParentGUIContent, true);

            if (objectsParent != null)
            {
                if (GUILayout.Button(new GUIContent("UpdateObjects")))
                {
                    _target.UpdateObjectBool = true;
                    EditorUtility.SetDirty(_target);
                }
            }
            EditorGUILayout.LabelField("Objects_VertexCount ", _target.objects_vertexCount.ToString());
